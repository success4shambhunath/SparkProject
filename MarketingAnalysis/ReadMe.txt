...
the output target (example, if duration=0 then y='no'). Yet, the duration is not known before a call is 
...
predictive model. 
# other attributes: 
12 - campaign: number of times a customer was contacted during the campaign (numeric, includes last 
contact) 
13 - pdays: number of days passed after the customer was last contacted from a previous campaign 
(numeric; 999 means customer was not previously contacted) 
...
The data size is huge and the Marketing team has asked you to use Spark to help them get answers for 
